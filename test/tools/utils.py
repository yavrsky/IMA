...
def set_ima_to_schain_nodes(schain_name, mainnet_url):
    ...
    for ip in ips:
        ...
        # set path to schain_config.json on local machine
...
def get_nodes_ips_from_file():
    skale_tests_py = os.path.join(proj_dir, '../skale_tests_py/config/nodes/array_of_ips.json')
